...
function () {
  ...
  _createClass(ApiSync, [{
    ...
    value: function save(data) {
      if (data.id) {
        return axios_1.default.put("".concat(this.rootUrl, "/").concat(data.id), data);
      }
...
var user = new Model_1.Model(new Attributes_1.Attributes({
  name: 'Pob',
  age: 55
}), new Eventing_1.Eventing(), new ApiSync_1.ApiSync(API_URL));
},{"./models/Model":"src/models/Model.ts","./models/Attributes":"src/models/Attributes.ts","./models/Eventing":"src/models/Eventing.ts","./models/ApiSync":"src/models/ApiSync.ts"}],"../../../../../../usr/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
